...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3753cf6f-e343-412d-9cc1-49b6f7c0cc6e
```

> `3753cf6f-e343-412d-9cc1-49b6f7c0cc6e` is the password of the certificate, you can change it to any password you want.
